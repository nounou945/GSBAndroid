...
public class FraisHfAdapter extends BaseAdapter {
	...
	public View getView(final int index, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.imgSupp=(ImageButton)convertView.findViewById(R.id.imgSupp);
			holder.imgSupp.setImageResource(R.drawable.suppr);
		...
		holder.imgSupp.setOnClickListener(new View.OnClickListener(){
			public void onClick(View v){


				lesFrais.remove(index);
				Serializer.serialize(Global.filename,Global.listFraisMois,context);// sauve le fait qu'on supprime un fhf
				notifyDataSetChanged(); // recharge la liste visuelle!
