...
public class NuiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuite);
    ...
    private void valoriseProprietes() {
        ...
        ((EditText)findViewById(R.id.txtNuits)).setText(String.valueOf(nuitee)) ;
    }
    ...
    private void imgReturn_clic() {
        ((ImageView)findViewById(R.id.imgNuitsReturn)).setOnClickListener(new ImageView.OnClickListener() {
    ...
    private void cmdValider_clic() {
        ((Button)findViewById(R.id.cmdNuitsValider)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Serializer.serialize(Global.filename, Global.listFraisMois, NuiteActivity.this) ;
                retourActivityPrincipale() ;
            }
        }) ;
    }
    ...
    private void cmdMoins_clic() {
        ((Button)findViewById(R.id.cmdNuitsMoins)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                nuitee = Math.max(0, nuitee-10) ; // suppression de 10 si possible
                enregNewQte() ;
            }
        }) ;
    }
    ...
    private void retourActivityPrincipale() {
        Intent intent = new Intent(NuiteActivity.this, MainActivity.class) ;
